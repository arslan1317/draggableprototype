  ...
  jQuery(document).ready(function($) {
          ...
          $.ajax({
              ...
              success: function(response){
                ...
                for(var i = 0;i < response.length; i++){
                  pos = pos;
                  $('#pro-box-screens').append('<div class="mobile-inner mt-0" style="left:'+pos+'rem;top:0;position:absolute;background-color:white">'+response[i]['act_code']+'</div>');
                  pos = pos + 17;
                }
      ...
      function assingStatusFunction(assignStatus){
        ...
        $('#assign-progress').css({'background-color' : 'blue','border-radius' : '50px'});
          ...
          errorBox('<p>Wait to Approved or Changed From Owner</p>');
